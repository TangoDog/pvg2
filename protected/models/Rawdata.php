 ...
 * @property string $pohx
 * @property string $pohx_dryeyes
 * @property string $pohx_oag_steroidresponse
 * @property string $past_medical_history
 * @property string $past_ocular_surgery
 * @property string $current_eye_medications
 * @property string $current_systemic_medications
...
class Rawdata extends fmActiveRecord
{
	...
	public function attributeLabels()
	{
		return array(
			...
			'diagnosis' => 'Diagnosis',
			'pohx' => 'Pohx',
			'pohx_dryeyes' => 'Pohx Dryeyes',
			'pohx_oag_steroidresponse' => 'Pohx Oag Steroidresponse',
			'past_medical_history' => 'Past Medical History',
			'past_ocular_surgery' => 'Past Ocular Surgery',
			'current_eye_medications' => 'Current Eye Medications',
			'current_systemic_medications' => 'Current Systemic Medications',
	...
	public function search()
	{
		...
		$criteria->compare('pohx',$this->pohx,true);
		$criteria->compare('pohx_dryeyes',$this->pohx_dryeyes,true);
		$criteria->compare('pohx_oag_steroidresponse',$this->pohx_oag_steroidresponse,true);
		$criteria->compare('past_medical_history',$this->past_medical_history,true);
		$criteria->compare('past_ocular_surgery',$this->past_ocular_surgery,true);
		$criteria->compare('current_eye_medications',$this->current_eye_medications,true);
		$criteria->compare('current_systemic_medications',$this->current_systemic_medications,true);
